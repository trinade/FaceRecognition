...
if __name__ == '__main__':
    ...
    embedding = face_embedding.convert_to_embedding(single=True, img_path='marcelo.jpg')
    #embedding = face_embedding.get_embedding()
    #print(embedding)
    #embedding2 = face_embedding.convert_to_embedding()
